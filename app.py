...
with tab1:
    ...
    # ---- Mes pico y Semana pico GLOBALES entre todos los meses
    # seleccionados (no solo el mes/año vigente) ----
...
with tab2:
    ...
    st.caption(
        ...
        "total quedan resaltadas en amarillo. La última fila muestra cuántas ciudades "
    ...
    tabla_ciudad_mes["Total"] = tabla_ciudad_mes.sum(axis=1, skipna=True)
    ...
    tabla_ciudad_mes_final = pd.concat([tabla_ciudad_mes, fila_resumen.to_frame().T])
