...
with tab1:
    ...
    with colA:
        ...
        st.caption(
            ...
            "Se resalta en amarillo solo el número de pedidos de la semana más fuerte de cada mes."
        )
        if tabla_semanal is None or tabla_semanal.empty:
            ...
            fig_semanal = px.bar(
                tabla_semanal_largo, x="Semana", y="Pedidos", color="Mes",
            ...
            fig_semanal.update_layout(height=340, xaxis_title="", yaxis_title="Pedidos")
